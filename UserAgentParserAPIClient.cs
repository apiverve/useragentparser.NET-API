...
namespace APIVerve
{
    public class UserAgentParserAPIClient
    {
        ...
        public UserAgentParserAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public UserAgentParserAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(useragentparserQueryOptions options)
        {
            try
            {
                if (_isDebug)
